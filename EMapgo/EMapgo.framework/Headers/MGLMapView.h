...
/**
 ...
 @param frame The frame for the view, measured in points.
 @param styleURL URL of the map style to display.
 */
...
/**
 ...
 loaded but before loading a style associated with a different EMapgo account.
...
/**
 The EMapgo logo, positioned in the lower-left corner.
 */
...
/**
 The position of the drawingNo label. The default value is `MGLOrnamentPositionBottomLeft`.
 */
@property (nonatomic, assign) MGLOrnamentPosition drawingNoPosition;

/**
 A `CGPoint` indicating the position offset of the drawingNo.
 */
@property (nonatomic, assign) CGPoint drawingNoMargins;
