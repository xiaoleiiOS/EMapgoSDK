...
/**
 ...
 EMapgo-hosted tiles has been downloaded and stored on the current device.
...
/**
 ...
 EMapgo-hosted tiles that may be downloaded and stored on the current device.
...
/**
 Sets the maximum number of EMapgo-hosted tiles that may be downloaded and
